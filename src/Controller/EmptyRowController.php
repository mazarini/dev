...
class EmptyRowController extends AbstractCrudController
{
    ...
    /**
     * @Route("/page-{page}.html", name="empty_row_page", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="empty_row_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="empty_row_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="empty_row_edit", methods={"GET","POST"})
     */
     ...
     * delete.
     *
     * @Route("/{id}", name="empty_row_delete", methods={"DELETE"})
     */
